    ...
    <section id="Popular and Recommended">
      ...
      <div class="descbg">
        <div class="bannerslides">
          <div class="hpbannerslides fade">
            <img src="../art/petaccessories.jpg" style="height: 400px; width: 1000px;">
          </div>

          <div class="hpbannerslides fade imgstyling">
        ...
        <div style="text-align:center">
          <span class="dot" onclick="bannerslide(1)"></span> 
          <span class="dot" onclick="bannerslide(2)"></span> 
          <span class="dot" onclick="bannerslide(3)"></span> 
        </div>
        <br><br>
      </div>
    </section>
